            ...
            <Box sx={{ backgroundColor: '#fff', minHeight: '100vh' }}>
                ...
                <Grid container justifyContent='center' alignItems='center' height='80vh'>
                    <Grid item md={4} xs={10}>
                        <Box sx={{border: "1px solid black", p: 5, borderRadius: '10px', backgroundColor: '#fff' }}>
                            <Box
                                sx={{
                                    display: 'flex',
                            ...
                            <Typography variant='subtitle1' className='textalign-center'>I have an account. <Link to='/login'>Log In</Link></Typography>
                        </Box>
                    </Grid>
                </Grid>
            </Box>
